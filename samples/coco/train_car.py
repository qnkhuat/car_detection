...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 49  # COCO has 80 classes
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=[48,49,50],
    ...
    def load_car(self, dataset_dir, subset,classes):
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        dataset_train.load_car(args.dataset, "cars_train",brands)
        dataset_train.prepare()

        # Validation dataset
        # dataset_val = CocoDataset()
        # dataset_val.load_car(args.dataset, "cars_train",brands)
        # dataset_val.prepare()
